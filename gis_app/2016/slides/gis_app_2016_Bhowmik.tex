...
\medskip \tiny{GIS Application, Winter Semester 2016}} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Avit Bhowmik]{Dr. Avit Kumar Bhowmik \\} % Your name
\institute[Stockholm Resilience] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Stockholm Resilience Centre, Stockholm University \\ % Your institution for the title page
\medskip
...
\href{https://github.com/AvitBhowmik/gisapp2016}{\alert{https://github.com/AvitBhowmik/gisapp2016}}\\
\vspace{1cm}
