...
\title[Open SouRce. Summer Academy `17]{Introduction to open source Spatial Analysis Tools and R\\
...
\frametitle{Who am I?}
\centering
\small{PostDoc, Stockholm Resilience Centre $|$ Lecturer, Universität Koblenz-Landau} \\[0.5cm]
\includegraphics[width=1.02\textwidth]{Figures/WC_pub.png}\\[0.5cm]
\raggedright
